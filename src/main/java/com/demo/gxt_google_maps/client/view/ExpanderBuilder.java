...
public class ExpanderBuilder {
    ...
    public String getBuilder(){
        ...
        expanderStringBuilder.append("<style type='text/css'>"+"ul.pixel-tabs{list-style-type:none;margin:0;padding:0;height:300px;overflow:visible;}ul.pixel-tabs li{display:inline-block;line-height:30px;}ul.pixel-tabs li a.tab{border-bottom:1px solid #eee;height:29px;}ul.pixel-tabs li a{color:#666;text-decoration:none;display:inline-block;padding:0px 12px;white-space:nowrap;}ul.pixel-tabs li a:hover{border-bottom:none;}ul.pixel-tabs li a.active-tab{background:#c1ddf1;border-left:1px solid #eee;border-right:1px solid #eee;border-top:1px solid #eee;border-radius:5px 5px 0 0;}.content-tab{border-top:1px solid #eee;margin: -1px 0 0 0;padding:0;}div.tabs{height:300px;overflow:hidden;}"+"table.underline{border-spacing:0;width:330px;}table.underline th:first-child{border-right:1px solid #eee;}table.underline th:first-child,table.underline td:first-child{width:170px;padding-left:7px;}table.underline th:last-child,table.underline td:last-child{width:240px;}table.underline th,table.underline td{border-bottom:1px solid #eee;height:20px;}table.underline tr:last-child th,table.underline tr:last-child td{border-bottom:none;}"+"</style>");
