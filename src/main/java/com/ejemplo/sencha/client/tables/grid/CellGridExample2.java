...
public class CellGridExample2 implements IsWidget {
    ...
    public Widget asWidget() {
        if (panel == null) {
            ...
            final ColumnConfig<Plant, Double> progressColumn = new ColumnConfig<Plant, Double>(properties.progress(), 150, "Progress");
            ...
            panel.setHeadingHtml("Cell Grid");
            panel.add(grid);
